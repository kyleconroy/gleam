...
func CountWords(s beam.Scope, lines gleam.PCollection[string]) gleam.PCollection[gleam.KV[string, int]]{
	s = s.Scope("CountWords")

	fn := extractFn{SmallWordLength: *smallWordLength}
	// do := gleam.DoFn[string, string]{fn.ProcessElement}
	// Convert lines of text into individual words.
	col := gleam.ParDoFn[string,string](s, &fn, lines)
...
func main() {
	...
	formatted := gleam.ParDoPerKey(s, formatFn, counted)
